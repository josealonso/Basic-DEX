...
contract Exchange is ERC20 {
    ...
    /**
     * @dev Swaps Eth for Complu Tokens
     */
    function ethToCompluToken(uint256 _minTokens) public payable {
        uint256 tokenReserve = getReserve();
        // call the `getAmountOfTokens` to get the amount of Complu tokens
        ...
        ERC20(compluTokenAddress).transfer(msg.sender, tokensBought);
    }
    ...
    function compluTokenToEth(uint256 _tokensSold, uint256 _minEth) public {
        ...
        ERC20(compluTokenAddress).transferFrom(
            msg.sender,
            address(this),
            _tokensSold
        );
